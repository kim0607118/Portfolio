...
void control(){
   ...
   int error = target_cart_velocity - cart_velocity; 
   float u = prev_u + (Kp + t_step * Ki) * error - Kp * prev_error ;
    
   //u = prev_u + (Kp + t_step * Ki) * error - Kp * prev_error ;
