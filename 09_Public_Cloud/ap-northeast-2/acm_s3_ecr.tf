...
resource "aws_ecr_repository" "jmeter_repository" {
  name = "jmeter_repository"
  image_tag_mutability = "MUTABLE"
  force_delete = true
...
output "jmeter_repository_url" {
  description = "The URL of the repository."
  value = aws_ecr_repository.jmeter_repository.repository_url
}
